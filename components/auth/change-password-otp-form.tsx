...
export function ChangePasswordOtpForm() {
  ...
  const [sendOtp, { isLoading: isSendingOtp }] = useSendChangePasswordOtpMutation()
  ...
  const onSendOtp = async () => {
    ...
    try {
      ...
      notifySuccess('Đã gửi OTP', 'Vui lòng kiểm tra email để lấy mã OTP đổi mật khẩu')
    } catch (error: any) {
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="password" placeholder="Nhập mật khẩu mới" disabled={isLoading} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="password" placeholder="Nhập lại mật khẩu mới" disabled={isLoading} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
